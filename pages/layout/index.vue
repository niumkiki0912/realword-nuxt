<template>
  <div>
    <nav class="navbar navbar-light">
      <div class="container">
        <nuxt-link to="/" exact class="navbar-brand">conduit</nuxt-link>
        <ul class="nav navbar-nav pull-xs-right">
          ...
          <template v-if="user">
            <li class="nav-item">
              <nuxt-link to="/editor" exact class="nav-link"><i class="ion-compose"></i>&nbsp;New Post</nuxt-link>
            </li>
            <li class="nav-item">
              <nuxt-link to="/settings" exact class="nav-link"><i class="ion-gear-a"></i>&nbsp;Settings</nuxt-link>
            </li>
            <li class="nav-item">
